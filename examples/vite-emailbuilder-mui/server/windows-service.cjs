...
svc.on('install', function () {
  ...
  console.log('App will be available at: https://infra.aap.cornell.com/apps/email-builder');
...
console.log('  Target URL: https://infra.aap.cornell.com/apps/email-builder');
